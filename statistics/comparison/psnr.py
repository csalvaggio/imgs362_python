...
if __name__ == '__main__':
   ...
   dataset1 = [1, 5, 8, 3, 2, 17]
   dataset2 = [1, 4, 8, 3, 1, 17]
   print(statistics.comparison.psnr(dataset1, dataset2, 255))
   print(statistics.comparison.psnr(dataset1, dataset2, 255, ignore=17))
   ...
   print(statistics.comparison.psnr(image1, image2, 255))
   print(statistics.comparison.psnr(image1, image2, 255, ignore=17))
